...
% ---- palette (same tokens as the website) ---------------------------------
...
\begin{minipage}{\textwidth}
  ...
  \vspace{4pt}
  {\normalsize\color{accent} Ph.D. Candidate · Open-Ended Visual Perception · Multimodal Foundation Models · Agentic AI}\par
  \vspace{7pt}
  {\small\color{muted}
...
\cvitem
  ...
  {\begin{itemize}
    ...
    \item Research: multimodal foundation models, open-ended visual understanding, image/video segmentation, and agentic AI. Expected graduation: December 2026.
  \end{itemize}}
